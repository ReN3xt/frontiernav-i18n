...
```
nodes.{ISO 639-1 Language Code}.json
```

See also [ISO 639-1 Language Code](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes).
...
If you don't want to translate something and let it fallback to English, just don't include it in the translated file.
